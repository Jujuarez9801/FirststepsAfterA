import java.util.*;
/************************************************************
 * This program allows two users to play Tic-Tac-Toe (also
 * called noughts and crosses). It demonstrates manipulating
 * 2D arrays
 * Author: Dr. Joshua Gross (jgross@csumb.edu)
 * Date: Spring 2023 (origjnal in C++)
 ************************************************************/
public class TicTacToeB {
    ...
    public static char getChar(int col, int row) {
        return (char)((col+1) + (SIZE * row) + 48);
//        return Character.forDigit((col+1) + (SIZE * row), 10);
    }
